...
public abstract class MaterialNavigationDrawer<Fragment> extends
	...
	protected abstract void setAccountDo();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (drawerHeaderType == DRAWERHEADER_ACCOUNTS) {
			...
			bio = (TextView) this.findViewById(R.id.bio);
			...
			bio.setTypeface(fontManager.getRobotoRegular());
			website.setTypeface(fontManager.getRobotoRegular());
		...
		init(savedInstanceState, toolbar);
		...
		if (deviceSupportMultiPane()) {
			...
			pulsante = new MaterialActionBarDrawerToggle<Fragment>(this,
				...
				public void onDrawerSlide(View drawerView, float slideOffset) {
					...
					if (!isCurrentFragmentChild) { // if user seeing a master
						// fragment
					...
					} else {// if user seeing a child fragment always shows the
						// back arrow
		...
		if (savedInstanceState == null) {
			...
			if (accountSelected >= BOTTOM_SECTION_START) {
				section = bottomSectionList.get(accountSelected
	...
	public void changeToolbarColor(MaterialSection section) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT)
			this.statusBar.setImageDrawable(new ColorDrawable(
	...
	public void notifyAccountDataChanged() {
		...
		case 1:
			...
			this.setBio(currentAccount.getBio());
			this.setWebsite(currentAccount.getWebsite());
		case 0:
		}
	}
	...
	public abstract void init(Bundle savedInstanceState, Toolbar toolbar);
